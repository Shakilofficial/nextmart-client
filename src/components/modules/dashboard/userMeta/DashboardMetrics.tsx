...
import { DatePickerWithRange } from "@/components/core/DateRangePicker";
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(data.totalRevenueForUser)}
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {data.orderData.find((item) => item.status === "Pending")
                ?.totalOrders || 0}
            </div>
            <div className="text-xs text-muted-foreground">
        ...
        <TabsContent value="sales" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detailed view of your sales performance
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="orders" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Monthly order trends and status breakdown
              </CardDescription>
            </CardHeader>
            <CardContent className="h-[400px]">
