...
const OrderCard = ({ order }: OrderCardProps) => {
  ...
  return (
    ...
    >
      {/* Order Header */}
      <div
        className={cn("p-4 sm:p-6", expanded ? "bg-gray-50/80" : "bg-gray-50")}
      >
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                ...
                className={cn(
                  ...
                  expanded && "bg-primary/10 text-primary hover:bg-primary/20"
                )}
              ...
              order.paymentMethod === "Online" && (
                <div className="flex gap-2">
                  <Button
                    variant="outline"
                    size="sm"
                    className="text-xs h-8 bg-green-600 text-white hover:bg-green-900 hover:text-white"
                  >
                    Make Payment
                  </Button>
                  <Button
