    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
        ...
        <p className="text-gray-500 mb-6 max-w-md">
          Your shop hasn&apos;t received any orders yet. Check back later!
        </p>
      </div>
    );
  }
    ...
    return ordersList.map((order) => (
      ...
      >
        ...
        <div
          className={cn(
            "p-4 sm:p-6",
            expandedOrders[order._id] ? "bg-gray-50/80" : "bg-gray-50"
          )}
        >
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row justify-between">
                      ...
                      <div className="flex items-center gap-4 mt-2 sm:mt-0">
                        <div className="text-right">
                          ...
                          <p className="text-xs text-gray-500">
                            List: ${item.product.price.toLocaleString()}
                          </p>
                        </div>
                        <Button
                          variant="ghost"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="space-y-2 text-sm bg-gray-50 p-4 rounded-md border border-gray-100">
                  ...
                  <p className="text-gray-700">
                    <span className="text-gray-500">Method:</span> Standard
                    Delivery
                  </p>
                  <p className="text-gray-700">
                ...
                <div className="space-y-2 text-sm bg-gray-50 p-4 rounded-md border border-gray-100">
                  ...
                  {order.coupon && (
                    <div className="flex justify-between">
                      ...
                      <p className="text-primary font-medium">{order.coupon}</p>
                    </div>
                  )}
