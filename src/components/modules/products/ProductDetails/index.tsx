...
const ProductDetails = ({ product }: ProductDetailsProps) => {
  ...
  const discountPercentage: number = product?.offerPrice
          ...
          <div className="space-y-2">
            {product.brand?.name && (
              <div className="flex items-center">
                <Badge
                  variant="outline"
                  className="text-xs font-medium px-2.5 py-0.5 bg-primary/5 text-primary border-primary/20"
                >
                  {product.brand.name}
                </Badge>
            ...
            {product.stock > 0 && (
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex items-center">
                  ...
                  <div className="h-9 px-4 flex items-center justify-center border border-input bg-background min-w-[3rem]">
                    {quantity}
                  </div>
                  <Button
                    type="button"
              ...
              <div className="space-y-4 text-sm sm:text-base text-gray-700">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-500 mt-1">
                      Delivered in 1-2 business days ($9.99)
                    </p>
                  </div>
                </div>
