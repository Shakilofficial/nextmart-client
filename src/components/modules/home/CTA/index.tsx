    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 w-full overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-rose-500 via-rose-600 to-rose-700 z-0"></div>
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <motion.div
              ...
              className="absolute top-0 left-0 w-96 h-96 bg-rose-300/20 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl"
            ></motion.div>
            <motion.div
              animate={floatingAnimation}
              custom={1}
              className="absolute bottom-0 right-0 w-96 h-96 bg-rose-200/30 rounded-full translate-x-1/2 translate-y-1/2 blur-3xl"
            ></motion.div>
          ...
          <div className="relative z-10 py-16 sm:py-20 md:py-24 px-6 sm:px-12 lg:px-16 flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-8 lg:gap-16">
            ...
            <div className="max-w-2xl text-center md:text-left">
              ...
              >
                <Button
                  size="lg"
                  className="bg-white text-rose-600 hover:bg-white/90 hover:text-rose-700 rounded-full px-8 py-6 text-base font-medium shadow-lg hover:shadow-xl transition-all duration-300 group"
                >
                  Shop Now
