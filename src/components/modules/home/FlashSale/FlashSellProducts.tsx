...
const FlashSaleProducts = ({ products }: FlashSaleProductsProps) => {
  ...
  return (
    <section className="relative py-12 md:py-20 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-rose-50 via-white to-rose-100 opacity-80"></div>
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -top-24 -left-24 w-64 h-64 bg-gradient-to-br from-rose-200 to-rose-200 rounded-full opacity-20 blur-3xl"></div>
        ...
        <div className="hidden md:block absolute top-10 right-10 text-rose-200 opacity-30">
          <Zap size={60} strokeWidth={1} />
        </div>
        <div className="hidden md:block absolute bottom-10 left-10 text-rose-200 opacity-30 rotate-12">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-16 bg-white/50 backdrop-blur-sm rounded-xl border border-rose-100">
            <Zap size={40} className="mx-auto text-rose-300 mb-3" />
        ...
        <div className="mt-10 text-center md:hidden">
          <Link href="/products">
            <Button className="rounded-full px-6 bg-rose-500 hover:bg-rose-600 text-white shadow-md">
              See More Deals
              <ChevronRightCircle className="ml-2 w-4 h-4" />
            </Button>
          </Link>
