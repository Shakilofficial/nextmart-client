...
const MyShop = async () => {
  ...
  return (
    <div className="container w-full py-10">
      ...
      <div className="relative w-full h-48 md:h-64 bg-gradient-to-r from-pink-600 to-rose-700 rounded-xl overflow-hidden mb-16">
        {/* Pattern overlay */}
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      {new Date(shop.user.lastLogin).toLocaleDateString(
                        "en-US",
                        {
                          year: "numeric",
                          month: "long",
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="flex flex-wrap gap-3">
                <Button className="w-full justify-start gap-2 bg-pink-600 hover:bg-pink-700">
